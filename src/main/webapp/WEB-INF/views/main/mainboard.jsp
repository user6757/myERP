            ...
            <tbody>
                <c:forEach var="list" items="${main}">
                    <tr>
                        ...
                        <td><a href="#"
                                onclick="detailepath('main', 'detaile?mainboardBno=${list.mainboardBno}')">${list.mainboardTitle}</a>
                        </td>
        ...
        <div class="bottom-section">
            ...
            <div class="create writing" align="left">
                <a class="btn btn-success"
                    onclick="mainboardpath('main', 'mainboardwriter?mainboardWriter=${boardname}')">글쓰기</a>
            </div>
            <!-- 페이지 버튼 영역 -->
