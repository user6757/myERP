      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item active">
          <a class="nav-link">
            ...
            <span>${main.mainboardWriter}</span>&nbsp;
            <br>
            <br>
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="/main/mainboard">
                ...
                <form name="modifyfrm">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td colspan="2"><input type="button" href="#" class="btn btn-primary" onclick="boardmodify()" value="글수정"/></td>
                            </tr>
                    <button type="button" class="btn btn-primary" onclick="boardDelete();">글삭제</button>
                &nbsp;&nbsp;&nbsp;
